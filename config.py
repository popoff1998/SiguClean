...
Q_STATS_BY_TYPE = 'SELECT SUM(NFICHEROS),SUM(NSIZE) FROM UT_ST_STORAGE WHERE IDSESION = %s AND TTAR LIKE %s'
Q_STATS_BY_TYPE_ALL = 'SELECT SUM(NFICHEROS),SUM(NSIZE) FROM UT_ST_STORAGE WHERE TTAR LIKE %s'
